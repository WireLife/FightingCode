...
char display[26][7] = { "黑桃A","黑桃2","黑桃3" ,"黑桃4" ,"黑桃5" ,"黑桃6" ,"黑桃7" ,"黑桃8" ,"黑桃9" ,"黑桃B" ,"黑桃J" ,"黑桃Q" ,"黑桃K",
...
const int maxn = 26;  //黑桃桃红桃桃加起来一共26张
char display[26][7] = { "黑桃A","黑桃2","黑桃3" ,"黑桃4" ,"黑桃5" ,"黑桃6" ,"黑桃7" ,"黑桃8" ,"黑桃9" ,"黑桃10" ,"黑桃J" ,"黑桃Q" ,"黑桃K",
						"红桃A","红桃2","红桃3" ,"红桃4" ,"红桃5" ,"红桃6" ,"红桃7" ,"红桃8" ,"红桃9" ,"红桃10" ,"红桃J" ,"红桃Q" ,"红桃K" }; 

int main()
{
	int i, j = 0, k = 1, sign[26] = { 0 }; //初始化
	while (1)
	{
		for (i = 0; i < 26; i++)     //思路就是把牌排成一排，从第一次开始翻，然后每隔2张再翻一次，一直翻到结尾再从头开始，遇到已经翻的跳过
		{
			if (sign[i] == 0)
			{
				if (j % 3 == 0)
